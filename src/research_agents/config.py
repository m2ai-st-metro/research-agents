...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    ...
    "latest ai agent framework demos showcasing innovative features 2026",
    "recent advancements in Claude agent capabilities for advanced applications 2026 insights",
