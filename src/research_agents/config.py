...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for recent community debates and technical challenges related to enhancing Model Context Protocol integration and AI agent functionality in the past week",
]
