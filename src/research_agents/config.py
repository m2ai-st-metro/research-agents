...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for recent GitHub repository activity and star growth related to Model Context Protocol advancements and AI agent skill development in the last week",
