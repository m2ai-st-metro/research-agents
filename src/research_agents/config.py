...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    ...
    "novel capabilities in latest ai agent framework presentations 2026",
...
GEMINI_RESEARCH_QUERIES: list[str] = [
    "Search for recent official releases and integrations of MCP server and Model Context Protocol updates from trusted sources within the last week",
    ...
    "Search for recent forum discussions and community feedback identifying gaps and proposing improvements in Model Context Protocol and AI agent functionalities",
]
