...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    ...
    "Claude autonomous agent system review and analysis 2026 comparison",
...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for recent AI agent framework and SDK launches featuring innovative features and improvements from the last week",
    "Search for GitHub repositories with recent star increases and active development on Model Context Protocol and AI agent skill enhancements in the last week",
