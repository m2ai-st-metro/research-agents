...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    "MCP server construction tutorial 2026",
    "AI agent launch showcase and user guide 2026",
    "Claude context protocol in autonomous agent management 2026",
    "AI agent pipeline design for workflow automation 2026",
    "AI coding assistant evaluation and comparison 2026",
]
...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for new releases and public announcements of AI agent frameworks, SDKs, and orchestration libraries from the past week",
    "Search for emerging GitHub repositories with recent spikes in star counts and activity focused on Model Context Protocol server advancements and AI agent skill development over the last week",
    "Search for recent introductions and debuts of workflow and pipeline automation tools for AI agents in the last seven days",
