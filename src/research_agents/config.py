...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for forum threads and developer discussions from the last week addressing shortcomings and enhancement proposals for MCP integrations and AI agent skills",
]
