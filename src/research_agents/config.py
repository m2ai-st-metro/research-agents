...
TOOL_SEARCH_QUERIES: list[str] = [
    "MCP server implementation demo projects",
...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    ...
    "AI agent framework introduction and feature exploration 2026",
    "Claude autonomous agent system review and analysis 2026",
    "AI agent pipeline design for workflow automation 2026",
    "AI coding assistants comparison and performance analysis 2026",
]
...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for discussions and feedback loops in forums over the past week addressing difficulties and suggestions for enhancing Model Context Protocol integration and AI agent capabilities",
]
