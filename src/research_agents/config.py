...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for GitHub repositories with recent increases in stars or active forks related to MCP server developments and AI agent skill plugins over the past week",
