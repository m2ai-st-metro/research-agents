...
YOUTUBE_SEARCH_QUERIES: list[str] = [
    ...
    "AI agent framework introduction demo 2026",
...
GEMINI_RESEARCH_QUERIES: list[str] = [
    ...
    "Search for recent community insights and feedback threads from the last week focusing on gaps and proposed improvements in MCP integrations and AI agent functionalities",
]
